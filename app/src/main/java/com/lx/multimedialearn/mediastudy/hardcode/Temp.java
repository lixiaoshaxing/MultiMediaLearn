 ...
 *
 * @author lixiao
 * @since 2017-11-29 18:22
 */
public class Temp extends AndroidTestCase {
    /*
...
//20140123: correct error checks on glGet*Location() and program creation (they don't set error)
    ...
    private static class CameraToMpegWrapper implements Runnable {
        ...
        private CameraToMpegWrapper(Temp test) {
            mTest = test;
        }
         ...
         * Entry point.
         */
        public static void runTest(Temp obj) throws Throwable {
