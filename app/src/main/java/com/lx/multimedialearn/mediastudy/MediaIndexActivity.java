...
import com.lx.multimedialearn.mediastudy.hardcode.OpenGLRecordActivity;
...
public class MediaIndexActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        list.add(new TabModel("6. 单独录制音视频-hardcode", "分别录制音频，视频到文件", MediaCodecActivity.class));
        list.add(new TabModel("7. MediaMux录制音视频-hardcode", "录制音视频封装为mp4", MediaMuxActivity.class));
        list.add(new TabModel("8. 录制带滤镜视频-filterrecord", "录制带滤镜视频", OpenGLRecordActivity.class));
