...
import com.lx.multimedialearn.openglstudy.render.OpenGlStudyRender2;
import com.lx.multimedialearn.openglstudy.view.CustomGLSurfaceView;
import com.lx.multimedialearn.utils.GlUtil;

/**
 * task4：OpenGL ES书籍的学习：空气曲棍球游戏的开发，动态桌面（为了方便，一下简称Open GL）
 */
