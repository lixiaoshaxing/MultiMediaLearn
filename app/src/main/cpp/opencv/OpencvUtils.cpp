...
Java_com_lx_multimedialearn_opencvstudy_OpenCVActivity_scan(JNIEnv *env, jclass type,
                                                            jobject srcBitmap,
...
extern "C"
JNIEXPORT void JNICALL
Java_com_lx_multimedialearn_opencvstudy_OpenCVActivity_crop(JNIEnv *env, jclass clazz,
                                                            jobject srcBitmap, jobjectArray points_,
                                                            jobject outBitmap) {
